...
public class Constants {
    ...
    //Storage positions
    public static final double STORAGE_EXTENDED_POSITION = 0.81;
    public static final double STORAGE_RETRACED_POSITION = 0.07;
    public static final double kStorageIdlePower = 0.3;
    public static final double kStorageRunPower = 1;
    public static final double kStorageShootPower = 0.7;

    //Shooter Constants:
    public static final double kShooterLvl3Rpm = 0.82;
    public static final double kShooterPwrshtRpm = 0.76;
    public static final double kShooterRPMAdjustment = 0.02;
    public static final double kShootAngle = -13;
    ...
    public static final double kYJacketTicksPerRevolution = (1+(46/17))*(1+(46/11))*28*2;
