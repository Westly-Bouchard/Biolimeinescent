...
import org.firstinspires.ftc.teamcode.commands.auto.ThreeRingDozer;
import org.firstinspires.ftc.teamcode.commands.looped.*;
import org.firstinspires.ftc.teamcode.commands.groups.JankyMcJankJank;

//This little annotation thingy is important, it's what makes the OpMode come up on the phone
@Autonomous
public class ThreeRingOneWobble extends AutoOpModeWrapper {      //Note that you extend the wrapper, not just an OpMode
    ...
    public void autoLoop() {
        scheduler.add(new DriveTelemetry());
        scheduler.add(new ThreeRingDozer(timekeeper));
    }
