...
public class DriveToPoint extends Command {
    ...
    public DriveToPoint(Timekeeper timekeeper, double x_target_input, double z_target_input, double angle_target_input) {
        ...
        angle_target = angle_target_input;
        ending_speed = 0;
    }
    ...
    public void initialize() {
        ...
        angle_target = (((((angle_target - driveTrain.getTrueHeading() + 180) % 360) + 360) % 360) - 180) + driveTrain.getTrueHeading();
    }

    public void execute() {
        CalculatePosition();
        if (ending_speed == 0) {
            //linear_speed = starting_speed;
